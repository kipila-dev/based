...
from based.cli.ui import console, error, success
from based.cli.utils import format_elapsed
from based.core.compiler import compile_source, standard_pipeline
...
def _version_callback(*, value: bool) -> None:
    if value:
        console.print(f"based {__version__}")
        raise typer.Exit
