...
from based.core.context import context
from based.core.dsl import Module
from based.core.errors import BasedValidationError
from based.ir import TargetNode, artifact_adapter, token_adapter
...
@module.export(name="_internal_create_target")
def create_target(target_id: str) -> None:
    ...
    if target_id in context.graph.targets:
        ...
        raise BasedValidationError(msg)
...
@module.export(name="_internal_target_add_token")
def target_add_token(target_id: str, token: dict[str, object]) -> None:
    ...
    try:
        ...
        raise BasedValidationError(msg) from None
...
@module.export(name="_internal_target_add_artifact")
